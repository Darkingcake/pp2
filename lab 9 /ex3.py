...
# основное окно программы,устанавливаются иконка,заголовок окна и кнопки
def main():
    ...
    brush_png = pygame.transform.scale(pygame.image.load("images/brush.jpg"), (20, 20))
    eraser_png = pygame.transform.scale(pygame.image.load("images/eraser.jpg"), (20, 20))
    clear_png = pygame.transform.scale(pygame.image.load("images/Clear.png"), (30, 30))
    save_png = pygame.transform.scale(pygame.image.load("images/save.png"), (98, 50))
    ...
    def size_buttons():
        ...
        sz_btn = pygame.transform.scale(pygame.image.load("images/size.jpg"), (25, 25))
    ...
    size_buttons()
    # бесконечный цикл для работы и рисования 
    while True:
